...
Der \textbf{Algorithmus} startet, indem er mit einem Seed $n$ verschiedene binäre Wörter $Y_1\ ...\ Y_n$ mit jeweils $w$ Bit generiert. Die Initialwörter können von einem anderen Pseudozufallszahlengenerator stammen. Hierbei muss drauf geachtet werden, dass nicht zu viele Wörter mit 0 initialisiert werden. Nach der Initialisierung, berechnet der Mersenne-Twister den nächsten Zustand.
