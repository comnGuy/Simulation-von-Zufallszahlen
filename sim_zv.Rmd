...
* \textbf{Lineare Kongruenzgeneratoren}
* \textbf{Schieberegister-Generatoren}
* \textbf{Tausworthe-Generatoren}
* \textbf{Kombinieren verschiedener Generatoren}
* \textbf{Inverse Kongruenzgeneratoren}
...
library(ggplot2)
data <- data.frame(x=seq(1:100), y=exp(seq(1:100)))
