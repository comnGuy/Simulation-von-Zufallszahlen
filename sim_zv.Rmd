...
Mit $F^{-1}(r)$ als Funktion `FhochMinusEins(r)` kann nun aus einer gleichverteilten Zufallszahl eine mit einer bestimmer Verteilung erzeugt werden.
```{}
double FRandGen() {
...
ggplot() + 
  geom_line(data=dat, aes(x=dat$x, y=dat$px, color="red")) +
  geom_line(data=dat2, aes(x=dat2$x, y=dat2$px, color="blue")) +
  labs(title="Verteilungsfunktion exp() und Umkehrfunktion")
```
