...
[1] L'Ecuyer definierte einen deterministischen Algorithmus durch die Sturkur $(a,b,c,d,e)$. %TODO% Wobei 

* $a$ ist ein endlich Set von Zuständen, 
* $b$ die Wahrscheinlichkeitverteilung,
* $c$ Initialisierter Zustand (Seed) $s_0$,
* $f : a -> a$ ist die Transitionsfunction, %TODO%
* $d$ Ausgabeplatz und
* $f : a -> d$ Aufgabefunktion, wobei $d = (0,1)$,
...
* jump-ahead Methode
    * Es wäre wünschenswert, wenn der Zufallsgenerator durch Berechnungen zu Zuständen springen kann $s_i => s_i+v$ %TODO%. Dabei soll $v$ groß sein und $i elment N$. Der Benefit von dieser Methode ist, dass durch die Teilung der Sequenze disjoint Streams und Substreams von zufälligen Zahlen erzeugt wird. 
