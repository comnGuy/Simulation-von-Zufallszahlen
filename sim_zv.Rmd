...
Um gleichverteilte Zufallszahlen zu erzeugen, 

### Mittquadratverfahren

* engl.: middle-square-method
* Einfacher RNG von John von Neumann
* siehe: Shiny app
...
### Inversionsmethode
Mit Hilfe der \textbf{Inversionsmethode} lassen sich (fast) beliebige diskrete und stetige Wahrscheinlichkeitsverteilungen aus gleichverteilten Zufallszahlen erzeugen.
...
* \textbf{Verwerfungsmethode (engl.: Acceptance-Rejection-Verfahren)}: Alternative zur Inversionsmethode, für Wahrscheinlichkeitsverteilungen, die zu komplex zu berechnen sind.
...
#dataPP = data.frame(data = PP.Coincidence(numberOfRandomNumbers), KindOfRandom = "PP-Coincidence")

#data <- rbind(datamt, datasd, dataPP)
